...
| "where does this brain page go", "file this in the brain", "brain taxonomist", "taxonomy check", "refile brain page", "which directory does this page go" | `skills/repo-architecture/SKILL.md` (taxonomist section) |
| "EIIRP", "everything in its right place", "store this research", "put this in the brain", "make this re-doable", "DRY this up", "file all of this", "organize all of this work", "archive this research thread" | `skills/maintain/SKILL.md` (organize) |
...
| Share a brain page as a link | `skills/brain-ops/SKILL.md` (publish) |
| "validate frontmatter", "check frontmatter", "fix frontmatter", "frontmatter audit", "brain lint" | `skills/maintain/SKILL.md` (frontmatter section) |
...
| Trigger | Skill |
|---------|-------|
| "capture this", "save this thought", "remember this", "drop this in the inbox", "save to brain" | `skills/idea-ingest/SKILL.md` (capture) |
...
| Post-restart health + auto-fix, "did the container restart break anything", smoke test | `skills/brain-ops/SKILL.md` (smoke) |
...
| "present options", "ask before proceeding", "choice gate", "user decision" | `skills/daily-task-manager/SKILL.md` (choice-gate) |

## Setup & migration

| Trigger | Skill |
|---------|-------|
| "Set up GBrain", first boot | `skills/gbrain-advisor/SKILL.md` (setup) |
| "Now what?", "fill my brain", "cold start", "bootstrap", "import my data", "what should I import first" | `skills/gbrain-advisor/SKILL.md` (cold-start) |
| "Migrate from Obsidian/Notion/Logseq" | `skills/maintain/SKILL.md` (migration) |
...
| "Upgrade gbrain", "update gbrain", "gbrain update available", `UPGRADE_AVAILABLE`, "is gbrain up to date" | `skills/gbrain-advisor/SKILL.md` (upgrade) |
...
5. When in doubt, ask the user (see `skills/daily-task-manager/SKILL.md` for the choice-gate pattern)
...
- `skills/daily-task-manager/SKILL.md` — choice-gate pattern for human input at decision points
...
| "add a page type", "add a type to my schema", "schema author", "schema mutate", "schema pack add", "my brain has untyped pages", "propose new types from my corpus", "backfill page types", "evolve my schema", "researcher type", "make X an expert type" | `skills/maintain/SKILL.md` (schema section) |
| "unify my types", "migrate to gbrain-base-v2", "94 types to 14", "apply canonical taxonomy", "clean up my page types", "pack upgrade", "shrink type proliferation", "consolidate page types", "retype pages to canonical" | `skills/maintain/SKILL.md` (schema section) |
